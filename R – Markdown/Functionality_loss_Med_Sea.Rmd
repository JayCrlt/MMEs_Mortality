...
Figure_data_paper <- ggplot(conservation_streamgraph, aes(x = year, y = Mortality.records)) +
  geom_bar(position="stack", stat="identity", color = "black", 
           aes(fill = Conservation.status)) +
  scale_y_continuous(limits = c(0, 350), name = "Motality records") +
  scale_x_continuous(breaks = seq(1980, 2020, 5), limits = c(1979, 2020), name = "") +
  theme_classic() + labs(fill = "Conservation status") +
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) +
  scale_fill_manual(values = c("#6f0000", "#bd0909", "#c85250", 
                               "#ff8c24", "#ffdc54", "#f1f292", "#ffffff")) +
  geom_label(data = nb_protected_sp, aes(x = year, label = nb_sp_protected), y = 350) 
